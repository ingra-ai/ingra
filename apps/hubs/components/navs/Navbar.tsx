...
import type { NavNotificationItem } from "./types";
...
export const Navbar: FC<PropsWithChildren<NavbarProps>> = (props) => {
  const { className, authSession, navNotificationItems = [] } = props;
            ...
            {navNotificationItems.length > 0 && (
              <Menu as="div" className="relative">
                <MenuButton className="flex items-center text-sm focus:outline-none">
                  ...
                  <Badge className="bg-red-300 px-2">
                    {navNotificationItems.length.toLocaleString(undefined, {
