                  ...
                  {isParent ? (
                        ...
                        {item.children.map((subItem) => (
                          <li className="" key={subItem.name} title={subItem.description} aria-label={subItem.description}>
                            <Link
                              ...
                              prefetch={true}
                              className={cn(
                                pathname.indexOf(subItem.href) >= 0 ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800',
                    ...
                    <div className="text-xs font-semibold leading-6 text-gray-400">
                      <Link
                        ...
                        className={cn(pathname.indexOf(item.href) >= 0 ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800', 'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold items-center')}
                      >
