...
const IntroductionScreen: React.FC<IntroductionScreenProps> = (props) => {
  ...
  const classes = cn(
    "flex flex-col items-center justify-center min-h-screen bg-gray-900 space-y-8 p-8 xl:p-12",
    className,
  );
  return (
    <div className={classes}>
      ...
      <p className="text-center max-w-screen-md leading-6 text-base">
        Your next-generation platform for creating and integrating custom
        automations. Imagine a world where you can have your own AI assistant,
        helping you automate and streamline your tasks effortlessly.
      </p>
