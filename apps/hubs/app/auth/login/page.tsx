import {
  ...
  APP_LEGAL_COOKPOL_URL,
  APP_LEGAL_PRIVACY_POLICY_URL,
  APP_LEGAL_TOS_URL,
  APP_NAME,
...
export default async function Page() {
  ...
  return (
    <div
      className="grid grid-cols-1 lg:grid-cols-12 lg:h-svh"
      data-testid="login-page"
    >
      <div className="col-span-1 lg:col-span-6 lg:bg-gray-900">
        <div
          className={
            "flex flex-col items-center justify-center lg:min-h-screen space-y-8 p-8 xl:p-12"
          }
        >
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <Image
              className="mx-auto h-12 w-12 xl:w-20 xl:h-20"
              src="/static/brand/ingra-logo.svg"
              alt={APP_NAME}
              width={96}
              height={96}
            />
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="text-xs text-center max-w-screen-md leading-6 text-muted-foreground">
              <a href={APP_LEGAL_PRIVACY_POLICY_URL} className="underline">
                Privacy Policy
              </a>{" "}
              |{" "}
              <a href={APP_LEGAL_TOS_URL} className="underline">
                Terms of Service
              </a>{" "}
              |{" "}
              <a href={APP_LEGAL_COOKPOL_URL} className="underline">
                Cookie Policy
              </a>
            </div>
      ...
      <div className="col-span-1 lg:col-span-6 flex flex-col justify-center items-center space-y-8 p-8 xl:p-12">
        <p className="text-xs text-center max-w-[440px] leading-5 text-muted-foreground lg:order-2 mt-0 lg:mt-12">
          {APP_NAME} is next-generation platform for curating and integrating
          custom automations. Imagine that you can have your own AI assistant in
          your pocket ready to do it for you. Let&apos;s automate stuffs.
        </p>
