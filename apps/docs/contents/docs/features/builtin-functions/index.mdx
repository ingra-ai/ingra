---
title: Understanding Ingra Built-in Functions
description: Discover the purpose of Ingra built-in functions, which enhance automation, extensibility, and rapid prototyping by allowing users to create and manage functions without coding.
---
## Built-in Functions
