---
title: Google API Integration in Ingra
description: A comprehensive guide to using optional Google API integration in Ingra to enhance productivity. Learn about Google API scopes and how they extend Ingra’s capabilities.
---

Ingra offers optional Google API integration to enhance its functionality, allowing you to interact with Google services like Calendar, Contacts, Gmail, Drive, and Sheets. This integration is not mandatory but is available for users who want to leverage specific functions that require access to Google services.
...
For enhanced security, we recommend visiting your Google Account connections section before proceeding with this step. This allows you to remove Ingra from your list of connected applications directly.
