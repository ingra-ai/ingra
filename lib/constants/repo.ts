...
export function getUserRepoCollectionsUri(ownerUsername: string): string {
  return USER_REPO_COLLECTIONS_URI
    .replace(':userName', ownerUsername);
}
...
export function getUserRepoCollectionsViewUri(ownerUsername: string, recordId: string): string {
  return USER_REPO_COLLECTIONS_VIEW_URI
    .replace(':userName', ownerUsername)
...
export function getUserRepoFunctionsUri(ownerUsername: string): string {
  return USER_REPO_FUNCTIONS_URI
    .replace(':userName', ownerUsername);
}
...
export function getUserRepoFunctionsNewUri(ownerUsername: string): string {
  return USER_REPO_FUNCTIONS_NEW_URI
    .replace(':userName', ownerUsername);
}
...
export function getUserRepoFunctionsViewUri(ownerUsername: string, recordId: string): string {
  return USER_REPO_FUNCTIONS_VIEW_URI
    .replace(':userName', ownerUsername)
    .replace(':recordId', recordId);
}
...
export function getUserRepoFunctionsEditUri(ownerUsername: string, recordId: string): string {
  return USER_REPO_FUNCTIONS_EDIT_URI
    .replace(':userName', ownerUsername)
    .replace(':recordId', recordId);
}
