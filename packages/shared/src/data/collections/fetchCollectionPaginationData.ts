...
export async function fetchCollectionPaginationData(searchParams: Record<string, string | string[] | undefined> = {}, options: FetchCollectionPaginationDataOptions = {}) {
  const { 
    invokerUserId = '',
    where: argsWhere = {},
  } = options;
...
export type FetchCollectionPaginationDataReturnType = Awaited<ReturnType<typeof fetchCollectionPaginationData>>;
