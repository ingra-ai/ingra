...
export const APP_GOOGLE_OAUTH_CALLBACK_URI = process.env.NEXT_PUBLIC_GOOG_OAUTH_CALLBACK_URI || '/api/v1/google-oauth/callback';
export const APP_GOOGLE_OAUTH_CALLBACK_URL = AUTH_APP_URL + APP_GOOGLE_OAUTH_CALLBACK_URI;
