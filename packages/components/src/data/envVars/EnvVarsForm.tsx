    ...
    return upsertEnvVar(values)
      ...
      .catch((error: Error) => {
        toast({
          ...
          description:
            error?.message ||
            "Failed to perform environment variable operation",
        });
    ...
    >
      <div>
        ...
        {formState.errors.key && (
          <p className="text-sm font-medium text-destructive-foreground mt-3 text-left">
