...
const FunctionArgumentInputSwitchField: FC<
  FunctionArgumentInputSwitchFieldProps
> = (props) => {
  ...
  switch (type) {
    ...
    case "boolean":
      return (
        <div
          className={`flex flex-row items-center space-x-3 space-y-0 px-2 py-2 ${classes}`}
        >
          <Switch
