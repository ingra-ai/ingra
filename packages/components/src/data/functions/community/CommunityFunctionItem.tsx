...
export const CommunityFunctionItem: React.FC<
  React.PropsWithChildren<CommunityFunctionItemProps>
> = (props) => {
    ...
    <div className="flex flex-col bg-secondary border border-gray-500 hover:border-gray-300 shadow-md rounded-sm px-4 py-2 w-full min-h-[200px]">
      ...
      >
        ...
        <span className="block">
          <span
            className={`px-2 py-1 inline-flex text-xs leading-3 font-semibold rounded-full bg-green-700 text-green-200`}
          >
            {authorName}
          </span>
