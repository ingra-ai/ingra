...
export const CommunityFunctionReadOnlyView: FC<
  CommunityFunctionReadOnlyViewProps
> = (props) => {
            ...
            {functionRecord && authVars !== false && (
              <div className="block">
                <Button
                  variant="ghost"
                  type="button"
                  className="flex w-[100px] justify-center rounded-md text-sm font-semibold"
          ...
          <TabsContent value="function-tab" className="block space-y-6">
            <div className="grid grid-cols-12 gap-x-4 gap-y-1">
              <div className="col-span-3 block">
                ...
                <p className="text-sm font-normal text-gray-300 leading-6">
            ...
            <div className="block">
              ...
              <p className="text-sm font-normal text-gray-300 leading-6">
                {functionRecord.tags.map((elem) => elem.name).join(", ")}
              </p>
            </div>
          </TabsContent>
                  ...
                  <tbody>
                    {functionRecord.arguments.map((item) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2 text-sm text-amber-500">
                          {item.type}
                        </td>
