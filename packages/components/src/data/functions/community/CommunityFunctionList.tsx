...
const CommunityFunctionsList: React.FC<CommunityFunctionsListProps> = (
  props,
) => {
    ...
    return subscribeToggleFunction(functionId)
      .then((result) => {
        ...
        toast({
          title: "Success!",
          description:
            result?.message || "Function has been subscribed successfully.",
        });
          ...
          {showControls && (
            <>
              <button
                type="button"
                disabled={isCloning}
                onClick={() => handleClone(functionRecord.id)}
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Subscribing to this function allows you to receive
                        updates and improvements made to the original version.
                        However, please note that you won&apos;t be able to
                        customize or modify the function.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
