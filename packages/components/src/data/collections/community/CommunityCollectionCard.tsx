...
const CommunityCollectionCard: React.FC<React.PropsWithChildren<CommunityCollectionCardProps>> = (props) => {
  ...
  return (
    <div data-testid="community-collection-card" {...divProps} className={classes}>
