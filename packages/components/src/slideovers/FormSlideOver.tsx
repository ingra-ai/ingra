...
export const FormSlideOver: FC<PropsWithChildren<FormSlideOverProps>> = (
  props,
) => {
                ...
                <DialogPanel className="flex flex-col pointer-events-auto w-screen max-w-2xl bg-secondary text-secondary-foreground max-h-full p-4 sm:p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-3 flex h-7 items-center">
                      <button
                        type="button"
                        className="relative rounded-md hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  ...
                  <div className="relative mt-6 flex-1 max-h-[93%] overflow-hidden overflow-y-auto px-1">
                    {children}
                  </div>
                </DialogPanel>
              </TransitionChild>
