import { generateToken, decodeToken } from '@lib/tokens';
...
describe('Token functions', () => {
  ...
  it('should generate a token', () => {
    ...
    expect(mockJwtSign).toHaveBeenCalledWith(payload, 'testSecret', { expiresIn: 180 });
  });
  ...
  it('should return null when decoding fails', () => {
    mockJwtVerify.mockImplementationOnce(() => { throw new Error('Decoding failed'); });
