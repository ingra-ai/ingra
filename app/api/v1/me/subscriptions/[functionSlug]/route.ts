...
export async function GET(req: NextRequest, { params }: { params: { functionSlug: string } }) {
  ...
  Logger.withTag('me-functions-subscriptions-route').withTag('GET').info(`Function handler ${ functionSlug } invoked.`);
...
export async function POST(req: NextRequest, { params }: { params: { functionSlug: string } }) {
  ...
  Logger.withTag('me-functions-subscriptions-route').withTag('POST').info(`Function handler ${ functionSlug } invoked.`);
  return await handlerFn(functionSlug, requestArgs);
}
...
export async function PUT(req: NextRequest, { params }: { params: { functionSlug: string } }) {
  ...
  Logger.withTag('me-functions-subscriptions-route').withTag('PUT').info(`Function handler ${ functionSlug } invoked.`);
  return await handlerFn(functionSlug, requestArgs);
}
...
export async function PATCH(req: NextRequest, { params }: { params: { functionSlug: string } }) {
  ...
  Logger.withTag('me-functions-subscriptions-route').withTag('PATCH').info(`Function handler ${ functionSlug } invoked.`);
  return await handlerFn(functionSlug, requestArgs);
}
...
export async function DELETE(req: NextRequest, { params }: { params: { functionSlug: string } }) {
  ...
  Logger.withTag('me-functions-subscriptions-route').withTag('DELETE').info(`Function handler ${ functionSlug } invoked.`);
  return await handlerFn(functionSlug, requestArgs);
}
