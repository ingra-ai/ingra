...
import type { FetchCollectionSubscriptionListPaginationType } from '@protected/subscriptions/collections/types';
    ...
    <div className="block" data-testid="functions-subscriptions-page">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6">Collection Subscriptions</h1>
